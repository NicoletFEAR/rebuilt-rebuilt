...
public class RobotContainer extends SubsystemBase {
        ...
        private Drive buildDrive() {
                return new Drive(
                                new SwerveModule(
                                                ...
                                                new RealCanCoder(
                                                                new CanCoderConfig(
                                                                                DeviceIds.FRONT_LEFT_CAN_CODER,
                                ...
                                new SwerveModule(
                                                ...
                                                new RealCanCoder(
                                                                new CanCoderConfig(
                                                                                DeviceIds.FRONT_RIGHT_CAN_CODER,
                                ...
                                new SwerveModule(
                                                ...
                                                new RealMotor(
                                                                new MotorConfig(
                                                                                ...
                                                                                KilogramSquareMeters.of(0.01))),
                                                new RealCanCoder(
                                                                new CanCoderConfig(DeviceIds.BACK_LEFT_CAN_CODER,
                                ...
                                new SwerveModule(
                                                ...
                                                new RealCanCoder(
                                                                new CanCoderConfig(
                                                                                DeviceIds.BACK_RIGHT_CAN_CODER,
        ...
        private Launcher buildLauncher() {
                return new Launcher(
                                new RealMotor(
                                                new MotorConfig(
                                                                DeviceIds.LEFT_LAUNCHER,
                                                                FlywheelConstants.FEEDFORWARD_VALUES, KrakenType.X60)),
                                new RealMotor(
                                                new MotorConfig(
                                ...
                                new RealMotor(
                                                new MotorConfig(
                                                                DeviceIds.INDEXER, IndexerConstants.FEEDFORWARD_VALUES,
                                                                KrakenType.X44)),
                                new RealMotor(
                                                new MotorConfig(DeviceIds.HOOD, HoodConstants.FEEDFORWARD_VALUES,
                                                                KrakenType.X44)),
                                new RealCanCoder(
                                                new CanCoderConfig(DeviceIds.HOOD_ENCODER, HoodConstants.HOOD_OFFSET)));
        }

        private Intake buildIntake() {
                return new Intake(
                                new RealMotor(
                                                new MotorConfig(DeviceIds.INTAKE_ARM, ArmConstants.FEEDFORWARD_VALUES,
                                                                KrakenType.X44)),
                                new RealMotor(
                                                new MotorConfig(
                                                                DeviceIds.INTAKE_WHEELS,
                                                                WheelConstants.FEEDFORWARD_VALUES, KrakenType.X44)));
        }
}
