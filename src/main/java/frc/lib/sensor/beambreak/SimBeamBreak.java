 ...
 * 
 * <p>
 * This class extends {@link BeamBreak} so that it can be used anywhere a
 * normal beam break sensor is expected. During simulation, the sensor is
...
public class SimBeamBreak extends BeamBreak {
     ...
     * 
     * <p>
     * The simulated sensor is reported as disconnected because no physical beam
     * break sensor is connected during simulation.
     * 
