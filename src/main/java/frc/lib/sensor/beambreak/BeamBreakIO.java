 ...
 * 
 * <p>
 * {@code BeamBreakIO} abstracts the hardware-specific implementation of a
 * beam break sensor. This allows the rest of the robot code to interact with
 * the sensor without depending on a specific hardware implementation.
 * 
 * <p>
 * Implementations of this interface are responsible for updating the sensor's
 * connection status and whether the beam is currently tripped.
 */
public interface BeamBreakIO {
     ...
     * automatically generate a {@code BeamBreakIOInputsAutoLogged} class for
     * logging these inputs.
     */
    @AutoLog
