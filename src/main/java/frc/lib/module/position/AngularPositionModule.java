 ...
 * and retrieving the mechanism's angular position. Motor rotor position is
...
public class AngularPositionModule extends Module {
     ...
     * 
     * <p>
     * The requested mechanism position is converted to rotor position using the
     ...
     * 
     * <p>
     * The motor's rotor position is converted to mechanism position using the
